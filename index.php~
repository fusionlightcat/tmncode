...
<body id="main_body" >
	...
	<div id="form_container">
		...
		<form id="form_719091" class="appnitro"  method="post" action="">
			...
			<h2>TMNCode Alpha 1 - Startseite</h2>
			<p>Klicke auf den Link unten, um einen Code einzulösen!
</p>
		</div>						
			<ul >
					...
					<li id="li_1" >
		<div align="center"> 
		<a href="./form/form.html" class="link">Code</a>
		</div> 
		</li>
